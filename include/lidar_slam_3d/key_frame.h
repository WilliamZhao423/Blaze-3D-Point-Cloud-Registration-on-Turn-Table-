...
public:
    ...
    KeyFrame(int id, const Eigen::Matrix4f& pose, const pcl::PointCloud<pcl::PointXYZ>::Ptr& cloud)  // TODO @Yimin Zhao
    {
        id_ = id;
        pose_ = pose;
        cloud_ = cloud;
    ...
    void setCloud(const pcl::PointCloud<pcl::PointXYZ>::Ptr cloud) { cloud_ = cloud; }  // TODO @Yimin Zhao
    ...
    pcl::PointCloud<pcl::PointXYZ>::Ptr getCloud() { return cloud_; } // TODO @Yimin Zhao
...
private:
    ...
    pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_; // TODO @Yimin Zhao
};
