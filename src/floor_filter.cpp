...
void FloorFilter::filter(const pcl::PointCloud<pcl::PointXYZ>::Ptr& source_cloud,
                         pcl::PointCloud<pcl::PointXYZ>::Ptr& filtered_cloud,
                         pcl::PointCloud<pcl::PointXYZ>::Ptr& floor_cloud)       // TODO @Yimin Zhao                 
{
    //pcl::PointCloud<pcl::PointXYZI>::Ptr clipped_cloud(new pcl::PointCloud<pcl::PointXYZI>);
    pcl::PointCloud<pcl::PointXYZ>::Ptr clipped_cloud(new pcl::PointCloud<pcl::PointXYZ>); // TODO @Yimin Zhao

    //pcl::PassThrough<pcl::PointXYZI> pass_through_filter;
    pcl::PassThrough<pcl::PointXYZ> pass_through_filter; // TODO @Yimin Zhao
    ...
    pcl::NormalEstimation<pcl::PointXYZ, pcl::Normal> normal_estimator; // TODO @Yimin Zhao
    pcl::search::KdTree<pcl::PointXYZ>::Ptr tree(new pcl::search::KdTree<pcl::PointXYZ>); // TODO @Yimin Zhao
    ...
    pcl::PointCloud<pcl::PointXYZ>::Ptr horizontal_cloud(new pcl::PointCloud<pcl::PointXYZ>); // TODO @Yimin Zhao
    ...
    //pcl::RandomSampleConsensus<pcl::PointXYZI> ransac(model_plane); // TODO @Yimin Zhao
    
    pcl::SampleConsensusModelPlane<pcl::PointXYZ>::Ptr model_plane(
          new pcl::SampleConsensusModelPlane<pcl::PointXYZ>(horizontal_cloud));
    ...
    pcl::PointCloud<pcl::PointXYZ>::Ptr outliers_cloud(new pcl::PointCloud<pcl::PointXYZ>); // TODO @Yimin Zhao
    pcl::ExtractIndices<pcl::PointXYZ> extract;  // TODO @Yimin Zhao
